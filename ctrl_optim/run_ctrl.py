...
def main():
    ...
    PARAMS_FILE_PATH = os.path.join(notebook_dir, "results", "optim_results","humotech_0925_1437", "myorfl_Kine_2D_1_25_2025Sep25_1437_None_Best.txt")
    ...
    MODEL = "humotech"           # Options: dephy, hmedi, humotech, osl, baseline
    ...
    MAX_TORQUE = 10           # Maximum exoskeleton torque
